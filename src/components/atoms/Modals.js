        ...
        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <Transition.Child
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg lg:max-w-4xl sm:w-full sm:p-6">
              <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4 mb-4">
                <button
                  type="button"
                  disabled={isLoading}
                  className={[
              ...
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  <Dialog.Title
                    as="h3"
                    className="text-lg text-left leading-6 font-medium text-gray-900 border-b pb-6">
                    {title}
                  </Dialog.Title>
              ...
              <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                <button
                  ...
                  disabled={isLoading}
                  className={[
                    'disabled:opacity-40 w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm',
                    isLoading && 'cursor-not-allowed',
                  ].join(' ')}
                  onClick={() => handlerShow(false)}>
                  Close
